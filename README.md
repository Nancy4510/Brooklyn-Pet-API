# **Brooklyn Pet API-Side**

This part of the project is the API side where the data is being held and stored. This application will allow users to create reservations for their furry friend! They can create, update, view and delete a reservation. In order to create a reservation, the user will need to sign up or if they are a returning user, they can sign in.
